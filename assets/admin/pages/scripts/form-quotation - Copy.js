                    ...
                    if (form.valid() == false) {
					 ...
					 if(index == 2) {
						 ...
						 if($('#qIds').length > 0) {
							 ...
							 var str = $('#qIds').val();
							 arrStr = str.split(',');
							 for(s = 0;s < (arrStr.length - 1);s++){
								  var result = 0; 
								 var inputType = $('#quest'+arrStr[s]).attr('type');
								 if(inputType == 'radio'){
									 var cStr = '';
									 var radioObj = document.getElementsByName('quest'+arrStr[s]);
									 for(r = 0;r < (radioObj.length);r++){
										 if(radioObj[r].checked == true) {
											 
											var str = radioObj[r].value.toLowerCase();
	
											if(str.trim() == "other"){
												cStr = cStr+radioObj[r].value+'|'+$('#other'+arrStr[s]).val()+'|';
											}else{
												cStr = cStr+radioObj[r].value+'|';
											}
									  ...
									  var checkObj = document.getElementsByName('quest'+arrStr[s]+'[]');
									  var cStr = '';
									  for(r = 0;r < checkObj.length;r++){
										 if(checkObj[r].checked == true) {
											 cStr = cStr+checkObj[r].value+'|';
											 result = 1;
											// break;
										 }
									 ...
									 if($('#quest'+arrStr[s]).val() != ''){
										 totalAns = totalAns+$('#quest'+arrStr[s]).val()+'#';
										 result = 1;
									 }
					 ...
					 if(index == 3) {
						if($('#qIds').length > 0) {
						 ...
						 for(r = 0;r < sObj.length;r++){
							 sStr = sStr+'<p style="width:500px" class="form-control-static" data-display="">'+sObj[r].value+'&nbsp;&nbsp;'+stObj[r].value+'&nbsp;&nbsp;'+seObj[r].value+'</p>';
						 }
